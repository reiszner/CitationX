...
var light_manager = {
    ...
    update: func {
        ...
        var noseheading = heading - math.asin(getprop("controls/gear/steering") / 2.0);
        ...
        var alt_agl = getprop("/position/gear-agl-ft") or 0.0;
...
#        apos.set_lat(lat + ((new3_xpos + proj_x) * ch + new3_ypos * sh) / me.lat_to_m);
#        apos.set_lon(lon + ((new3_xpos + proj_x)* sh - new3_ypos * ch) / me.lon_to_m);
        ...
        setprop("/sim/rendering/als-secondary-lights/lightspot/dir[2]", noseheading);
