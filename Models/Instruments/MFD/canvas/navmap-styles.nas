...
# SurferTim
    me.Styles.DME.color_default = [0,1,0];  #rgb
...
#    me.Styles.FIX_cit = {}; # generated in FIX.symbol file
#    me.Styles.FIX_cit.color = [0,0.6,0.9]; 
#    me.Styles.FIX_cit.fill_color = [0,0.6,0.9,0];
#    me.Styles.FIX_cit.scale_factor = 1; 
#    me.Styles.FIX_cit.text_offset = [3, 0];
#    me.Styles.FIX_cit.text_color = [0,0.6,0.9,0];
#    me.Styles.FIX.text_bgcolor = [1,1,1,1]; 
#    me.Styles.FIX_cit.text_mode = canvas.Text.TEXT;
#    me.Styles.FIX_cit.text_padding = 1;
#    me.Styles.FIX_cit.text_alignment = 'left-bottom';
