...
##### Christian Le Moigne (clm76) - August 2021 ###
...
var nav_type = "autopilot/settings/nav-source";
...
#	  setlistener("systems/electrical/outputs/dme1",func(n) {
    setlistener("systems/electrical/outputs/efis",func(n) {
...
# SurferTim
		me.text.navType.setText(getprop(nav_type)).setColor(left(getprop(nav_type),3) == "FMS" ? me.blue : me.green);
		me.text.hdgAnn.setText(sprintf("%03d",getprop(hdg_ann)));
		if (getprop(dist_rem) > 0 and left(getprop(nav_type),3) == "FMS")
			me.text.distRem.setText(sprintf("%.0f",getprop(dist_rem))~" NM").setColor(me.blue);
